...
@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {
  ...
  [dir=ltr] button.q-btn--actionable:active:hover .q-btn__content {
    margin: -1px 1px 1px -1px;
  }
  [dir=rtl] button.q-btn--actionable:active:hover .q-btn__content {
    margin: -1px -1px 1px 1px;
  }
  .q-btn-group > button.q-btn--push.q-btn--actionable .q-btn__content {
    transition: 0.3s cubic-bezier(0.25, 0.8, 0.5, 1);
  }
  [dir] .q-btn-group > button.q-btn--push.q-btn--actionable:active:hover .q-btn__content {
    margin: 0;
  }
  .q-carousel__slide > * {
    max-width: 100%;
