    ...
    methods: {
      ...
      __mobileTouch: function __mobileTouch (evt) {
        ...
        this.touchTimer = setTimeout(function () {
          this$1.show(evt);
          this$1.anchorEl.classList.remove('non-selectable');
        }, 300);
      },
    ...
    methods: {
      __preventScroll: function __preventScroll (state) {
        if (
          ...
          prevent$1(state, this.$q.platform.is);
        }
      }
    }
  };
      ...
      if (this.input === true) {
        contentMiddle.push(h(QInput, {
          ...
          on: {
            ...
            keyup: function (e) { e.keyCode === 13 && this$1.__update(); },
            blur: function () { this$1.__update(); }
          }
        }));
      }
      else { // is type select
