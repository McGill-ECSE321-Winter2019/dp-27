...
public class StudentGetCoopInfoIT extends ControllerIT {
    ...
    public void studentHasAtLeastOneCoopTerm() throws Exception {
        ...
        employerContactDto1 = createTestEmployerContact(companyDto1, "John", "Smith", "smithy@smithy.com", "12345678");
        ...
        employerContactDto2 = createTestEmployerContact(companyDto2, "Mark", "Zucc", "zucc@fb.com", "111453678");
    ...
    public void getCoopInformationForStudent() throws Exception {
        ...
        assertEquals("Lightspeed", coopDto1.getCoopDetails().getEmployerContact().getCompany().getName());
        assertEquals("Facebook", coopDto2.getCoopDetails().getEmployerContact().getCompany().getName());
