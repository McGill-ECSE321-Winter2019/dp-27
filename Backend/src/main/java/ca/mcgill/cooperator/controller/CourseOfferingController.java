...
public class CourseOfferingController {
    ...
    @PostMapping("")
    public CourseOfferingDto createCourseOfferingDto(@RequestBody CourseOfferingDto courseOfferingDto) {
    	CourseOffering courseOffering = new CourseOffering();
    	CourseDto courseDto = courseOfferingDto.getCourse();
    	Course course = courseService.getCourseById(courseDto.getId());
    	
    	courseOffering = courseOfferingService.createCourseOffering(courseOfferingDto.getYear(), 
    																courseOfferingDto.getSeason(), 
    																course);
